//! Vendored from succinctlabs/sp1-solana (verifier/src/utils.rs, MIT OR Apache-2.0),
//! with the loaders made public. Unchanged otherwise.
...
pub fn load_public_inputs_from_bytes(buffer: &[u8]) -> Result<PublicInputs<2>, Error> {
